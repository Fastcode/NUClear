...
template <typename TTrigger>
void NUClear::Internal::ReactorMaster::Implementation::subscribe(NUClear::Reactor* reactor) {
    std::set<NUClear::Reactor*>& bindings = getReactorBindings<TTrigger>();
    bindings.insert(reactor);
}

template <typename TTrigger>
std::set<NUClear::Reactor*>& NUClear::Internal::ReactorMaster::Implementation::getReactorBindings() {
...
template <typename TData>
std::shared_ptr<TData> NUClear::Internal::ReactorMaster::Implementation::get() {
...
template <typename TTrigger>
void NUClear::Internal::ReactorMaster::Implementation::emit(TTrigger* data) {
    cache<TTrigger>(data);
